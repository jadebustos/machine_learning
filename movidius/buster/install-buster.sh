...
# installation script for debian buster
buster_script=$(pwd)'/install-ncsdk.sh.buster'
...
# modifications to install on buster
sudo cp $buster_script /opt/movidius/NCSDK/install-ncsdk.sh
